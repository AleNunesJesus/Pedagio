...
import { importarPosicoes, type ImportacaoState } from "../actions";
...
export function ImportarPosicoesForm() {
  const [state, formAction] = useActionState(importarPosicoes, initialState);
    ...
    <form ref={formRef} action={formAction} className="space-y-3">
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
          Cabeçalhos esperados: placa, latitude, longitude (graus decimais),
          data (DD/MM/AAAA), horario (HH24:MI ou HH24:MI:SS). A revalidação
          das passagens pendentes desses veículos acontece automaticamente.
          Veja docs/importacao.md.
        </p>
      </div>
